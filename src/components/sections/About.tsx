...
export default function About() {
  ...
  return (
    <section id="about" className="sofia-medium relative px-4 lg:px-12 bg-[#F8F3FF] py-12 lg:pb-12 pt-20 h-full">
      ...
      <div className="space-y-2 lg:space-y-4">
        <h2 className="text-black/10 text-2xl md:text-5xl font-bold ">ABOUT</h2>
        ...
        <div className="flex flex-col md:flex-row items-center w-full justify-between gap-5">
          ...
          <div className="w-full flex  items-center justify-center">
            <div className="w-[90%] lg:w-[80%]">
              ...
              <SplitText className="text-base lg:text-lg text-[#454545]">We believe</SplitText>

              <div className="text-[#454545] text-sm md:text-base flex flex-col gap-4 py-8 ">
