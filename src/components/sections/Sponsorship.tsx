...
export default function SponsorShip() {
  return (
    ...
    >
      ...
      <div className="flex gap-5 flex-col md:flex-row pb-6 md:pb-12 lg:pb-16 mt-8 lg:mt-32 items-start z-20">
        <div className="flex flex-col items-start justify-center md:px-16 w-full gap-8">
        ...
        <div className="w-full  flex  justify-center ">
          <div className="space-y-5  md:max-w-sm">
            <div className="flex items-center ju gap-2 z-20 md:gap-3">
